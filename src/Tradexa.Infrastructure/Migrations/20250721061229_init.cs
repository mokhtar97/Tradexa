        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LayoutPreference = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductProvider_Product_ProductsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductProviderPrice", x => new { x.ProductId, x.ProviderId, x.EffectiveDate });
                    table.ForeignKey(
                        name: "FK_ProductProviderPrice_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductProviderPrice_Provider_ProviderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductProviderPrice_ProviderId",
                table: "ProductProviderPrice",
                column: "ProviderId");
        }
